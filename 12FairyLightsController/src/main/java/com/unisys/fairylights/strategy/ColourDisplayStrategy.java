...
/**
 * This provides colour display strategy as described in the assignment document.
 * <p/>
 * <b>colour : all of the red lights are turned on for 1 second, then all the green for 1 second then all the white for 1 second As soon as the algorithm
 * completes, it should start again.</b>
 * <p/>
 */
public class ColourDisplayStrategy extends AbstractDisplayStrategy {
	...
	private static final int WAIT_TIME = 1000; // 1 sec
